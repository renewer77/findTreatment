# Find Treatment Prototype - Speech-to-Text Testing

A simple prototype website for testing speech-to-text functionality using the Web Speech API.
...
- Connect to your backend API in the `sendToAI()` function (line ~180)
...
This is a prototype for testing and development purposes. The `sendToAI()` function in `speachToText.html` is a placeholder and needs to be connected to your actual backend API.
